      ...
      <div className="grid grid-cols-1 gap-6 mb-8">
        <div className="bg-white border-3 border-black p-6 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]">
          ...
          <ul className="space-y-3">
            <li className="flex items-center gap-3 p-3 bg-emerald-100 border-2 border-black cursor-pointer hover:bg-emerald-200 transition font-bold">
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path><polyline points="14 2 14 8 20 8"></polyline><line x1="12" y1="18" x2="12" y2="12"></line><line x1="9" y1="15" x2="15" y2="15"></line></svg>
              Create Test Case
            </li>
            <li className="flex items-center gap-3 p-3 bg-violet-100 border-2 border-black cursor-pointer hover:bg-violet-200 transition font-bold">
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="3" y="4" width="18" height="18" rx="2" ry="2"></rect><line x1="16" y1="2" x2="16" y2="6"></line><line x1="8" y1="2" x2="8" y2="6"></line><line x1="3" y1="10" x2="21" y2="10"></line></svg>
              Create Test Plan
            </li>
            <li className="flex items-center gap-3 p-3 bg-amber-100 border-2 border-black cursor-pointer hover:bg-amber-200 transition font-bold">
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><polygon points="5 3 19 12 5 21 5 3"></polygon></svg>
              Start Test Run
            </li>
            <li className="flex items-center gap-3 p-3 bg-indigo-100 border-2 border-black cursor-pointer hover:bg-indigo-200 transition font-bold">
