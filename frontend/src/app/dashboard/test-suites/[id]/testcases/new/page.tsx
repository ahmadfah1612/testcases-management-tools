...
export default function NewTestCasePage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      router.push(`/dashboard/test-suites/${suiteId}`);
    } catch (error: any) {
      ...
      <div className="max-w-4xl mx-auto">
        <div className="flex items-center gap-4 mb-8">
          ...
          <div>
            ...
            <p className="text-gray-600">Create a new test case for this suite</p>
          </div>
        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="flex items-center gap-4 p-6 bg-[rgb(0,191,255)]/10 border-2 border-black">
              ...
              <div>
                ...
                <p className="text-gray-600">Provide basic information for your test case</p>
              </div>
            </div>
